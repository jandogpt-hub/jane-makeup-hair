...
<main class="bg-background-dark text-white pt-24 pb-12 font-display">
    ...
    <section class="relative px-6 py-24 md:py-32 overflow-hidden border-solid border-b border-white/10">
        <div class="absolute inset-0 z-0">
            <img class="w-full h-full min-w-full min-h-full max-w-none object-cover object-top opacity-20 filter grayscale" alt="Bridal updo hairstyle back view by Jane in West Hollywood" src="https://res.cloudinary.com/jane-makeup-hair/image/upload/w_2000,h_1333,c_fill,g_face,q_80,fl_keep_iptc/v1772307264/bridal-updo-hairstyle-8-jane-makeup-hair-west-hollywood_f5jibq.jpg" />
        ...
        <div class="container relative z-10 max-w-4xl mx-auto text-center">
            ...
            <h1 class="text-[8vw] md:text-6xl font-black uppercase tracking-tighter mb-6 leading-none">Mobile Bridal Makeup & Hair</h1>
    ...
    <section class="px-6 py-24 relative">
        <div class="container max-w-6xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
                <div class="order-2 md:order-1 relative rounded-2xl overflow-hidden border-solid border border-white/10 p-2" style="background: rgba(255,255,255,0.02);">
    ...
    <section class="px-6 py-24 border-y border-white/10 relative overflow-hidden" style="background: linear-gradient(180deg, rgba(201,168,76,0.03) 0%, transparent 100%);">
        <div class="container max-w-6xl mx-auto text-center mb-16">
            ...
            <h2 class="text-[7.5vw] md:text-5xl font-black uppercase tracking-tighter">Real Brides &amp; Bridal Parties</h2>
        </div>
        <div class="container max-w-6xl mx-auto">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="group relative rounded-2xl overflow-hidden border-solid border border-white/10 aspect-[4/5]">
                ...
                <div class="group relative rounded-2xl overflow-hidden border-solid border border-white/10 aspect-[4/5] sm:col-span-2 lg:col-span-1">
    ...
    <section class="px-6 py-32 relative text-center">
        <div class="container max-w-3xl mx-auto relative z-10">
            <h2 class="text-[7.5vw] md:text-5xl font-black uppercase tracking-tighter mb-6">Ready to See Your Bridal Look?</h2>
