...
<main class="font-display">
    ...
    <section class="max-w-7xl mx-auto px-6 py-28 bg-background-dark relative z-20 overflow-hidden">
        <div class="flex flex-col md:flex-row items-start md:items-end justify-between gap-6 md:gap-0 mb-16 border-b border-white/10 pb-6">
            <div>
                ...
                <h2 class="text-[7.5vw] md:text-5xl font-black tracking-tighter uppercase leading-none text-white">Signature Services</h2>
            </div>
    ...
    <section id="why-jane" class="relative py-28 px-6 bg-background-dark overflow-hidden">
        ...
        <header class="relative z-10 text-center mb-20">
            ...
            <h2 class="text-[8vw] md:text-6xl font-black uppercase tracking-tighter leading-none mb-6">
                Why Choose<br>
    ...
    <section id="reviews" class="relative py-24 px-6 bg-background-dark overflow-hidden">
        ...
        <header class="relative z-10 text-center mb-16">
            ...
            <h2 class="text-[7.5vw] md:text-5xl font-black uppercase tracking-tighter leading-none">
