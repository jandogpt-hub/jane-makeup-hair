...
require_once __DIR__ . '/../includes/config.php'; $city = 'Studio City';
...
<main class="bg-background-dark text-white pt-24 pb-12 font-display">
    ...
    <section class="relative px-6 py-24 md:py-32 overflow-hidden border-solid border-b border-white/10">
        <div class="absolute inset-0 z-0">
            <img class="w-full h-full min-w-full min-h-full max-w-none object-cover object-top opacity-20 filter grayscale" alt="Jane Makeup & Hair in Studio City" src="https://res.cloudinary.com/jane-makeup-hair/image/upload/w_2000,h_1333,c_fill,g_face,q_80,fl_keep_iptc/v1772246476/jane-mobile-makeup-hair-west-hollywood-010_ehtzdf.jpg" />
        ...
        <div class="container relative z-10 max-w-4xl mx-auto text-center">
            ...
            <h1 class="text-[8vw] md:text-6xl font-black uppercase tracking-tighter mb-6 leading-none">Makeup Artist Studio City</h1>
    ...
    <section class="px-6 py-24 relative">
        <div class="container max-w-4xl mx-auto">
            <div class="relative rounded-2xl border-solid border border-white/10 p-8 md:p-12 mb-16" style="background: rgba(255,255,255,0.02);">
                <h2 class="text-3xl font-black uppercase tracking-tight mb-8">Studio City’s Mobile Beauty Artist</h2>
                <div class="space-y-4">
                    <p class="text-white/70 leading-relaxed text-lg">Studio City sits at the heart of the San Fernando Valley’s entertainment industry — home to CBS, NBC, and countless production facilities. Jane’s TV production background makes her a natural fit for Studio City clients who need a reliable, professional beauty artist on short notice. She also serves Studio City brides, event clients, and everyday clients seeking a premium at-home experience.</p>
                </div>
            </div>
        </div>
    </section>
